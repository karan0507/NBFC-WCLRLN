...
export class StageTriggersComponent implements OnInit {
      ...
      onFocusMethod(type) {
            if (type == 'product') {
                  ...
                  let params = { 'source': 'Onboarding', endpoint: '11', 'datapoint': 'get-stage-statuses' }
      ...
      getFormLoanData(tableFilter?) {
            ...
            var data = { 'datapoint': 'loan_application', 'endpoint': 'LoanApplication?stage_id=11', 'source': 'Onboarding' }
      ...
      updateStatus(type?, data?) {
            ...
            switch (type) {
                  case 'status':
                        this._isStatus = true;
                        this.https.getStageMaster(11).subscribe(res => {
                              if (res?.success) {
      ...
      exportData(file_formate?) {
            ...
            let data = { source: 'Onboarding', datapoint: 'export_application_by_stage',stage_id:  11}

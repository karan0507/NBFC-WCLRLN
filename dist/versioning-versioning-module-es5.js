(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["versioning-versioning-module"], {
    ...
    /***/
    function FS50(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VersioningComponent", function () {
      ...
      function VersioningComponent_tr_31_td_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function VersioningComponent_tr_31_td_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 11);
      ...
      function VersioningComponent_tr_31_i_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function VersioningComponent_tr_31_i_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function VersioningComponent_tr_31_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function VersioningComponent_div_32_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var VersioningComponent = /*#__PURE__*/function () {
        function VersioningComponent(service, message, fb) {
          _classCallCheck(this, VersioningComponent);
        ...
        _createClass(VersioningComponent, [{
          key: "ngOnInit",
          ...
          value: function getVersion() {
            ...
            this.service.getAppVersion().subscribe(function (res) {
              if (res === null || res === void 0 ? void 0 : res.success) {
                // this.message.success(res?.message)
                // console.log(res?.data['VERSION']);
                _this.versionForm.patchValue({
              ...
              _this.apiLoader['getLoader'] = false;
            }, function (error) {
              _this.apiLoader['getLoader'] = false;
            });
          }
        }, {
          key: "onClickUpdateVersion",
          value: function onClickUpdateVersion() {
            var _this2 = this;

            var data = new FormData(); // console.log(this.versionForm.value);
            // data.append()

            this.apiLoader['onUpdate'] = true;
            this.service.updateAppVersion(this.versionForm.value).subscribe(function (res) {
              if (res === null || res === void 0 ? void 0 : res.success) {
                _this2.message.success(res === null || res === void 0 ? void 0 : res.message);

                _this2.apiLoader['onUpdate'] = false; // this.getVersion();
              } else {
          ...
          value: function fetchVersionList(tableFilter) {
            var _this3 = this;
            ...
            this.service.fetchVersionList(data).subscribe(function (res) {
              _this3.api_calling_loader = false;
              _this3.listOfData = res['data'];

              _this3.versionForm.get('is_optional').setValue(_this3.listOfData[0].is_optional);

              _this3.total_count = res['data'].total_count; // this.message.success(res['message'])
            }, function (err) {
              _this3.api_calling_loader = false;
            });
          }
      ...
      VersioningComponent.ɵfac = function VersioningComponent_Factory(t) {
        return new (t || VersioningComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ng_zorro_antd_message__WEBPACK_IMPORTED_MODULE_3__["NzMessageService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
      };

      VersioningComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: VersioningComponent,
        selectors: [["ing"]],
        decls: 33,
        vars: 18,
        consts: [[3, "formGroup"], [1, "row", "align-items-baseline"], [1, "col-md-5"], ["nzFor", "name", "nzRequired", "", 1, "text-left", 3, "nzSm", "nzXs"], ["nzErrorTip", "Please Add Valid Version!", 3, "nzSm", "nzXs"], ["nz-input", "", "type", "text", "formControlName", "app_version", "placeholder", "App Version"], ["nz-checkbox", "", "formControlName", "is_optional", 1, "ml-3"], ["nz-checkbox", "", "formControlName", "system_status", 1, "ml-3"], [1, "col-md-12", 2, "text-align-last", "right"], ["nz-button", "", "nzType", "primary", 3, "nzLoading", "click"], [3, "nzTotal", "nzLoading", "nzFrontPagination", "nzPageIndex", "nzPageSize", "nzPageSizeOptions", "nzShowSizeChanger", "nzData", "nzQueryParams"], ["nzWidth", "5rem"], [4, "ngFor", "ngForOf"], ["class", "total_count_text", 4, "ngIf"], ["nzWidth", "5rem", 4, "ngIf"], ["nz-icon", "", "nzType", "check-circle", 3, "nzTheme", "nzTwotoneColor", 4, "ngIf"], ["nz-icon", "", "nzType", "close-circle", 3, "nzTheme", "nzTwotoneColor", 4, "ngIf"], ["nz-icon", "", "nzType", "check-circle", 3, "nzTheme", "nzTwotoneColor"], ["nz-icon", "", "nzType", "close-circle", 3, "nzTheme", "nzTwotoneColor"], [1, "total_count_text"]],
        template: function VersioningComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function VersioningComponent_Template_button_click_15_listener() {
              return ctx.onClickUpdateVersion();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("nzQueryParams", function VersioningComponent_Template_nz_table_nzQueryParams_17_listener($event) {
              return ctx.listOfData[0] ? ctx.fetchVersionList($event) : "";
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VersioningComponent, [{
    ...
    /***/
    function GJhX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VersioningRoutingModule", function () {
        return VersioningRoutingModule;
      });
      /* harmony import */
      ...
      var _versioning_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var VersioningRoutingModule = function VersioningRoutingModule() {
        _classCallCheck(this, VersioningRoutingModule);
      };

      VersioningRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: VersioningRoutingModule
      });
      VersioningRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function VersioningRoutingModule_Factory(t) {
          return new (t || VersioningRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](VersioningRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VersioningRoutingModule, [{
    ...
    /***/
    function ubIE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VersioningModule", function () {
      ...
      var _versioning_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./versioning.component */
      "FS50");
      /* harmony import */


      var _versioning_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./versioning-routing.module */
      "GJhX");
      /* harmony import */
      ...
      var VersioningModule = function VersioningModule() {
        _classCallCheck(this, VersioningModule);
      };

      VersioningModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: VersioningModule
      });
      VersioningModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function VersioningModule_Factory(t) {
          return new (t || VersioningModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _versioning_routing_module__WEBPACK_IMPORTED_MODULE_3__["VersioningRoutingModule"], _ng_zorro_antd_module__WEBPACK_IMPORTED_MODULE_4__["DemoNgZorroAntdModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], ng_zorro_antd_modal__WEBPACK_IMPORTED_MODULE_6__["NzModalModule"], ngx_permissions__WEBPACK_IMPORTED_MODULE_7__["NgxPermissionsModule"].forChild()]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](VersioningModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VersioningModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
            declarations: [_versioning_component__WEBPACK_IMPORTED_MODULE_2__["VersioningComponent"]],
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _versioning_routing_module__WEBPACK_IMPORTED_MODULE_3__["VersioningRoutingModule"], _ng_zorro_antd_module__WEBPACK_IMPORTED_MODULE_4__["DemoNgZorroAntdModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"], ng_zorro_antd_modal__WEBPACK_IMPORTED_MODULE_6__["NzModalModule"], ngx_permissions__WEBPACK_IMPORTED_MODULE_7__["NgxPermissionsModule"].forChild()]
...
//# sourceMappingURL=versioning-versioning-module-es5.js.map